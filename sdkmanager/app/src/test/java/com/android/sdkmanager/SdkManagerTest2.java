...
public class SdkManagerTest2 extends SdkManagerTestCase {
    ...
    public void testListDevices() throws Exception {
        ...
        assertEquals(
                ...
                "P     OEM : Google\n" +
                "P ---------\n" +
                "P id: 18 or \"2.7in QVGA\"\n" +
                "P     Name: 2.7\" QVGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 19 or \"2.7in QVGA slider\"\n" +
                "P     Name: 2.7\" QVGA slider\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 20 or \"3.2in HVGA slider (ADP1)\"\n" +
                "P     Name: 3.2\" HVGA slider (ADP1)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 21 or \"3.2in QVGA (ADP2)\"\n" +
                "P     Name: 3.2\" QVGA (ADP2)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 22 or \"3.3in WQVGA\"\n" +
                "P     Name: 3.3\" WQVGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 23 or \"3.4in WQVGA\"\n" +
                "P     Name: 3.4\" WQVGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 24 or \"3.7 FWVGA slider\"\n" +
                "P     Name: 3.7\" FWVGA slider\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 25 or \"3.7in WVGA (Nexus One)\"\n" +
                "P     Name: 3.7\" WVGA (Nexus One)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 26 or \"4in WVGA (Nexus S)\"\n" +
                "P     Name: 4\" WVGA (Nexus S)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 27 or \"4.65in 720p (Galaxy Nexus)\"\n" +
                "P     Name: 4.65\" 720p (Galaxy Nexus)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 28 or \"4.7in WXGA\"\n" +
                "P     Name: 4.7\" WXGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 29 or \"5.1in WVGA\"\n" +
                "P     Name: 5.1\" WVGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 30 or \"5.4in FWVGA\"\n" +
                "P     Name: 5.4\" FWVGA\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 31 or \"7in WSVGA (Tablet)\"\n" +
                "P     Name: 7\" WSVGA (Tablet)\n" +
                "P     OEM : Generic\n" +
                "P ---------\n" +
                "P id: 32 or \"10.1in WXGA (Tablet)\"\n" +
